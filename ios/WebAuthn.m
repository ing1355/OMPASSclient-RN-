...
RCT_EXTERN_METHOD(Register: (NSString *) fidoAddress domain :(NSString *) domain accessKey : (NSString *) accessKey username : (NSString *) username clientInfo : (NSString *) clientInfo displayName : (NSString *) displayName token : (NSString *) token authorization : (NSString *) authorization challenge : (NSString *) challenge userId : (NSString *) userId errorCallback : (RCTResponseSenderBlock)errorCallback successCallback : (RCTResponseSenderBlock)successCallback)
...
RCT_EXTERN_METHOD(Authenticate: (NSString *) fidoAddress domain : (NSString *) domain accessKey : (NSString *) accessKey username : (NSString *) username authorization : (NSString *) authorization  challenge : (NSString *) challenge userId : (NSString *) userId clientInfo : (NSString *) clientInfo errorCallback : (RCTResponseSenderBlock)errorCallback successCallback : (RCTResponseSenderBlock)successCallback)
